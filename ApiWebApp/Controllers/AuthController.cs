...
public class AuthController
    (
    UserManager<AppUsers> userManager, TokenService tokenService, 
    IEmailService emailService, WebAppContext context,LogCleanupService logCleanupService
    ) : ControllerBase
{
    ...
    private readonly LogCleanupService _logCleanupService = logCleanupService;
    // Login action
    [EnableCors("AllowAll")]
    [HttpPost("login")]
